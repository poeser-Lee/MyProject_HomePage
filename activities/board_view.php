...
<html>
	<head>
		<meta charset="utf-8">
		<title>서전주 중학교>교육활동 마당</title>
		<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/activities/board_list.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/activities/board_list.js"></script>
		...
		<section>
			<div id="board_box">
                ...
                <?php
                    ...
                    if ($userid !== $id) {
                        $new_hit = $hit + 1;
                        $sql = "update activities set hit=$new_hit where num=$num";
