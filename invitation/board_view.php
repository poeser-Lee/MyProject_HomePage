...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/invitation/board_list.css">
		<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/invitation/board_list.js"></script>
		...
		<section>
			<div id="board_box">
                ...
                <?php
                    ...
                    if ($userid !== $id) {
                        $new_hit = $hit + 1;
                        $sql = "update invitation set hit=$new_hit where num=$num";
