...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css"
            href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/support/board_list.css">
      <script src="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/support/board_list.js" defer></script>
               ...
               <li class = "menu">
                  ...
                  <span class="col6">조회</span>
                    ...
                    <?php
                        ...
                        $sql = "select * from boardsupport order by num desc";
