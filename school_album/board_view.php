...
<html>
	<head>
		<meta charset="utf-8">
		<title>서전주 중학교 >학교 앨범</title>
		<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/school_album/css/board.css">
		<script src="http://<?= $_SERVER["HTTP_HOST"] ?>/myproject_homepage/school_album/js/board.js" defer></script>
		...
		<section>
			<div id="board_box">
                ...
                <?php
                    ...
                    if ($userid !== $id) {
                        $new_hit = $hit + 1;
                        $sql = "update album set hit=$new_hit where num=$num";
				...
				<div id="ripple">
					...
					<div id="ripple2">
                        <?php
                            $sql = "select * from `album_ripple` where parent='$num' ";
                            ...
                            while ($ripple_row = mysqli_fetch_array($ripple_result)) {
								...
								<div class="ripple_title">
									<ul class = "ripple">
										...
										<li class = "date"><?= $ripple_id . "&nbsp;&nbsp;" . $ripple_date ?></li>
									</ul>
								</div>
