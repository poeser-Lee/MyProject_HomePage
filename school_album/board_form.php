...
<html>
	...
	<head>
		<meta charset="utf-8">
		<title>서전주 중학교> 학교 앨범> 수정하기</title>
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/school_album/css/board.css">
		<script src="http://<?= $_SERVER["HTTP_HOST"] ?>/myproject_homepage/school_album/js/common.js" defer></script>
