<?php
    ...
    if (isset($_POST["mode"]) && $_POST["mode"] === "delete") {
        $num = $_POST["num"];
        $page = $_POST["page"];
        $sql = "select * from boardstudent where num = $num";
        ...
        $sql = "delete from boardstudent where num = $num";
     ...
     //   include_once $_SERVER['DOCUMENT_ROOT'] . "/myproject_homepage/db/db_connect.php";
      ...
      history.go(-1)
        ...
        $sql = "insert into boardstudent (id, name, subject, content, regist_day, hit,  file_name, file_type, file_copied) ";
   ...
   ";
        ...
        $sql = "update boardstudent set subject='$subject', content='$content',  file_name='$upfile_name', file_type='$upfile_type', file_copied= '$copied_file_name'";
        $sql .= " where num=$num";
        mysqli_query($con, $sql);
