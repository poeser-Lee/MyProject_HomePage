...
<html>
   ...
   <head>
      <meta charset="utf-8">
      <title>게시판>학생 마당>글쓰기</title>
      <link rel="stylesheet" type="text/css"
            href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/student`s yard/board_list.css">
      <script src="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/student`s yard/board_list.js" defer></script>
   </head>
