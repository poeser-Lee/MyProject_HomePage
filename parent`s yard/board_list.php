...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css"
            href="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/parent`s yard/board_list.css">
      <script src="http://<?= $_SERVER['HTTP_HOST'] ?>/myproject_homepage/parent`s yard/board_list.js" defer></script>
               ...
               <li class = "menu">
                  ...
                  <span class="col6">조회</span>
                    ...
                    <?php
                        ...
                        $sql = "select * from boardparent order by num desc";
                        ...
                        for ($i = $start; $i < $start + $scale && $i < $total_record; $i++) {
                            ...
                            // result_set이 가르키고 있는 레코드를 연관배열로 가져옴
                            // 하나의 레코드 가져오기
                            $num = $row["num"];
                            $id = $row["subject"];
                            $id = $row["id"];
